...
COMMON_TRAIN_FORMAT = [
    ...
    ('g_ag_distance', 'GAG', 'float'),
    ('ag_eg_distance', 'AGEG', 'float'),
    ('g_eg_distance', 'GEG', 'float')
]
...
class AverageMeter(object):
    ...
    def value(self):
        ...
        return round(self._sum / max(1, self._count), 3)
...
class Logger(object):
    def __init__(self,
        ...
        self._train_mg = MetersGroup(os.path.join(log_dir, 'train' + str(seed))+"_"+reward_batch+"_"+num_interact,
                                     formating=train_format)
        self._eval_mg = MetersGroup(os.path.join(log_dir, 'eval'+ str(seed))+"_"+reward_batch+"_"+num_interact,
        ...
        #     project="hfrl",
        #     name=log_dir.split('/')[-1] + "_" + str(seed)
        #
